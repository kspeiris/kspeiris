...
|--------|-------------|------|
| **Sales Management System** | Inventory and sales management platform | JavaScript, PHP, MySQL |
| **Hotel Management System** | Reservation and billing system | Node.js, React, MongoDB |
| **Campus Event System** | University event management platform | Python, Flask |

### Machine Learning Projects

| Project | Description | Accuracy |
|--------|-------------|----------|
| **Health Risk Predictor** | Disease prediction model | 92% |
| **Course Recommender** | Recommendation system | 87% |
| **Stock Prediction Model** | Time-series forecasting | 85% |

---

## ✍️ Technical Writing

I publish articles on **software engineering, AI systems, web security, and modern architecture**.
